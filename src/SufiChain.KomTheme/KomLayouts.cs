...
/// <summary>
/// Layout constants for the KomTheme.
/// Defines the different layout variants available.
/// </summary>
public static class KomLayoutNames
{
    /// <summary>
...
/// Use this when configuring <see cref="KomThemeBlazorOptions.Layout"/>.
/// </summary>
/// <remarks>
/// The actual layout types (SideMenuLayout, TopMenuLayout) are defined in the
/// SufiChain.KomTheme.Blazor package. This class provides a convenient way to
/// reference them without hardcoding type names.
/// </remarks>
public static class KomLayouts
{
    ...
    public static Type SideMenu
    {
        get => _sideMenuLayout ?? throw new InvalidOperationException(
            "SideMenuLayout type has not been registered. Ensure SufiChain.KomTheme.Blazor is properly configured.");
    ...
    public static Type TopMenu
    {
        get => _topMenuLayout ?? throw new InvalidOperationException(
            "TopMenuLayout type has not been registered. Ensure SufiChain.KomTheme.Blazor is properly configured.");
    ...
    public static Type DualSidebar
    {
        get => _dualSidebarLayout ?? throw new InvalidOperationException(
            "DualSidebarLayout type has not been registered. Ensure SufiChain.KomTheme.Blazor is properly configured.");
    ...
    public static Type Account
    {
        get => _accountLayout ?? throw new InvalidOperationException(
            "AccountLayout type has not been registered. Ensure SufiChain.KomTheme.Blazor is properly configured.");
    ...
    public static Type Empty
    {
        get => _emptyLayout ?? throw new InvalidOperationException(
            "EmptyLayout type has not been registered. Ensure SufiChain.KomTheme.Blazor is properly configured.");
