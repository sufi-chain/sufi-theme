/**
 * KomTheme - Viewport breakpoint (classic script for Blazor global invocation).
 * Loaded via script bundle; attaches KomThemeViewportInit and KomThemeViewportDispose to window.
 */
(function () {
    'use strict';
    ...
    window.KomThemeViewportInit = function (dotNetRef, breakpointPx, id) {
    ...
    window.KomThemeViewportDispose = function (id) {
