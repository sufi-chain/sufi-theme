...
namespace SufiChain.KomTheme.Blazor.Server.Authorization;

/// <summary>
/// Bridges ABP <see cref="IPermissionChecker"/> to SufiAbp menu/toolbar permission filtering.
/// </summary>
public class KomThemeAuthorizationPermissionChecker : ISufiAbpPermissionChecker
{
    private readonly IPermissionChecker _permissionChecker;

    public KomThemeAuthorizationPermissionChecker(IPermissionChecker permissionChecker)
    {
