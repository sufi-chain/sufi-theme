...
using SufiChain.KomTheme.Blazor.Server.Authorization;
...
using SufiChain.KomTheme.Blazor.Server.Users;
...
public class KomThemeBlazorServerModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.Replace(ServiceDescriptor.Scoped<ISufiAbpPermissionChecker, KomThemeAuthorizationPermissionChecker>());
        ...
        Configure<BundleOptions>(options =>
        {
            ...
            // kom-theme.js is optional/on-demand (ES module); menu expand/collapse is Blazor + CSS only
